...
```{r simulation-plots, fig.cap="相同理論變異數下，標準化 Student-t(5) 的尾端比常態分配厚。"}
old_par <- par(
...
```{r empirical-plots, fig.cap="MSFT 與等權教學投資組合的時間圖、經驗分配與常態 Q--Q 圖。", fig.width=10, fig.height=7.5}
series_list <- list(
...
```{r acf-diagnostics, fig.cap="MSFT 與等權教學投資組合的報酬 ACF 與平方報酬 ACF。", fig.width=9, fig.height=7}
old_par <- par(
